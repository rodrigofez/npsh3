...
class NpshProvider extends ChangeNotifier {
  ...
  void updatePresionEntrada(
    ...
    print(_points.map((point) => point.qInicial));
  ...
  Map<String, dynamic> toJson() => {
        '_points': _points.map((point) => point.toJson()),
        '_observationPoints': _observationPoints
            .map((step) => step.map((point) => point.toJson())),
        '_npshPoints': _npshPoints.map((point) => point.toJson()),
        '_marca': _marca,
        '_serie': _serie,
  ...
  NpshProvider.fromJson(Map<String, dynamic> json)
